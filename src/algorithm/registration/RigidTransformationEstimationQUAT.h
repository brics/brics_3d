...
#ifndef BRICS_3D_RIGIDTRANSFORMATIONESTIMATIONQUAT_H_
#define BRICS_3D_RIGIDTRANSFORMATIONESTIMATIONQUAT_H_
...
#endif /* BRICS_3D_RIGIDTRANSFORMATIONESTIMATIONQUAT_H_ */
