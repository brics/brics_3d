...
class ObjectModelNormalPlane : public ObjectModelPlane, public IObjectModelUsingNormals{
...
public:
    ...
    void
      selectWithinDistance (const Eigen::VectorXf &model_coefficients, double threshold,
