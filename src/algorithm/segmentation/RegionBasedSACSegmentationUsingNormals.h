...
#ifndef BRICS_3D_REGIONBASEDSACSEGMENTATIONUSINGNORMALS_H_
#define BRICS_3D_REGIONBASEDSACSEGMENTATIONUSINGNORMALS_H_
...
#endif /* BRICS_3D_REGIONBASEDSACSEGMENTATIONUSINGNORMALS_H_ */
