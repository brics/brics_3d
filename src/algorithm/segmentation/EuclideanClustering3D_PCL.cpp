...
#include "EuclideanClustering3D_PCL.h"
...
EuclideanClustering3D_PCL::EuclideanClustering3D_PCL() {
...
int EuclideanClustering3D_PCL::segment(){
...
void EuclideanClustering3D_PCL::extractClusters(BRICS_3D::PointCloud3D *inCloud){
...
void EuclideanClustering3D_PCL::extractClusters(BRICS_3D::ColoredPointCloud3D *inCloud){
	extractedClusters.clear();
	BRICS_3D::PCLTypecaster pclTypecaster;
